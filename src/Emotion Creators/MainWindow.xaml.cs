...
namespace InitSetting
{
    public partial class MainWindow : Window
    {
        ...
        #region Emotion Creators Speciffic code
        ...
        {
            EnvironmentHelper.StartProcess("http://www.illusion.jp/preview/emocre/manual/index.html");
        }

        private void buttonMaps_Click(object sender, RoutedEventArgs e)
        {
            EnvironmentHelper.OpenDirectory("UserData\\map\\data");
        }

        private void buttonPoses_Click(object sender, RoutedEventArgs e)
        {
        ...
        {
            EnvironmentHelper.OpenDirectory("UserData\\edit\\scene");
        }
