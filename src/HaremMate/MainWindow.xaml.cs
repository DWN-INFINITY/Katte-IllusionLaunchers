...
namespace InitSetting
{
    public partial class MainWindow : Window
    {
        ...
        private const string RegistryKeyGame = "Software\\illusion\\HaremMate";
        private const string RegistryKeyStudio = "Software\\illusion\\HaremMate";
        private const string ExecutableGame = "HaremMate.exe";
        private const string ExecutableStudio = "HaremStudio.exe";
